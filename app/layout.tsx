...
const CSP = [
  "default-src 'self'",
  "connect-src 'self' https://api.github.com https://github-contributions-api.deno.dev https://ws.audioscrobbler.com https://wttr.in https://api.wolfx.jp https://api.monkeytype.com https://api.rss2json.com https://wakatime.com https://api.lolicon.app https://bing.biturl.top https://api.injahow.cn https://osu-sig.s23.moe https://www.clarity.ms https://cloud.umami.is https://cdn.busuanzi.cc",
  "font-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com",
  "img-src 'self' https://ui-avatars.com https://osu-sig.s23.moe https://www.bing.com https://i.pximg.net https://*.music.126.net https://lastfm.freetls.fastly.net https://api.injahow.cn data: blob:",
  "media-src 'self' https://*.music.126.net https://*.netease.com https://api.injahow.cn",
